...
```
git clone https://github.com/SU-SWS/j8 my-drupal-site
```

Navigate in to the root of the repository:
...
Then follow the prompts. Once it has been completed you should have a fully functioning drupal website in the `web` directory.
